...
function toggleTlChildren(el){var row=el.closest('[onclick*="ganttRowClick"]');var wrapper=row.parentNode;var c=wrapper.querySelector('.tl-children');if(c){c.style.display=c.style.display==='none'?'block':'none';el.textContent=c.style.display==='none'?'▶':'▼'}}
