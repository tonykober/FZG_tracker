...
function renderTimeline(){
  ...
  let h='<div style="position:relative"><div style="display:flex;border-bottom:1px solid var(--border);padding:4px 0;margin-bottom:6px"><div style="width:150px;flex-shrink:0;font-size:0.75rem;color:var(--muted);border-right:1px solid var(--border);margin-right:4px">任務</div><div style="flex:1;display:flex;position:relative">';
...
function renderOutsourceFromCache(){
  ...
  if(outsourceMode==='gantt'){
    ...
    const days=new Date(y,m+1,0).getDate();
    const weekdays=['日','一','二','三','四','五','六'];
    let gh='<div class="timeline"><div style="position:relative"><div style="display:flex;border-bottom:1px solid var(--border);padding:4px 0;margin-bottom:6px"><div style="width:150px;flex-shrink:0;font-size:0.75rem;color:var(--muted);border-right:1px solid var(--border);margin-right:4px">任務</div><div style="flex:1;display:flex">';
